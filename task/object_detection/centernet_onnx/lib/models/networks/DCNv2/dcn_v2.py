...
print("enter load ext for cuda:",torch.cuda.is_available())
try:
    if torch.cuda.is_available():
        from .gpu_ext import _ext as _backend
    else:
        from .cpu_ext import _ext as _backend
...
class _DCNv2(Function):
    ...
    def symbolic(g, input, offset_mask, weight, bias, stride, padding, dilation, deformable_groups):
        ...
        return g.op("ai.onnx.contrib::_DCNv2", input, offset_mask, weight, bias, stride_i=stride, padding_i=padding,
