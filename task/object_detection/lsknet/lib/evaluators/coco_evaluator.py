...
# from task.object_detection.yolox.lib.data.datasets import COCO_CLASSES
from task.object_detection.lsknet.lib.utils import (
    gather,
    is_main_process,
    postprocess,
    synchronize,
...
class COCOEvaluator:
    ...
    def evaluate_prediction(self, data_dict, statistics):
        ...
        logging.info("Evaluate in main process...")
