...
import task.object_detection.lsknet.lib.utils.dist as comm
...
def _distributed_worker(
    ...
    logging.info("Rank {} initialization finished.".format(global_rank))
    try:
        ...
        logging.error("Process group URL: {}".format(dist_url))
        raise
