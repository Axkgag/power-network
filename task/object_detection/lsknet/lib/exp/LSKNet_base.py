...
class LSKNetExp(BaseExp):
    def __init__(self):
        ...
        self.test_ann = "test_annoatations.json"
    ...
    def get_model(self):
        ...
        from ..models import LSK, PAFPN, HEAD
        ...
        if getattr(self, "model", None) is None:
            ...
            backbone = PAFPN(img_size=self.input_size[0], in_channels=in_channels, act=self.act)
            head = HEAD(self.num_classes, in_channels=in_channels, act=self.act)
            self.model = LSK(backbone, head)
    ...
    def get_eval_loader(self, batch_size, is_distributed, testdev=False, legacy=False):
        ...
        valdataset = COCODataset(
            ...
            name=self.val_img if not testdev else self.test_img,
    ...
    #     from ...yolox_trainer import Trainer
