...
model_urls = {
    'efficientnet_v2_s': "./weights/efficientnet_v2_s-dd5fe13b.pth",
    'efficientnet_v2_m': "./weights/efficientnet_v2_m-dc08266a.pth",
    'efficientnet_v2_l': "./weights/efficientnet_v2_l-59c71312.pth"
}
...
class MBConv(nn.Module):
    def __init__(
        ...
        layers.append(se_layer(expanded_channels, squeeze_channels, activation=nn.ReLU(inplace=False)))
        # project
        layers.append(
            Conv2dNormActivation(
...
class EfficientNet(nn.Module):
    def __init__(
        ...
        layers.append(
            Conv2dNormActivation(
                3, firstconv_output_channels, kernel_size=3, stride=2, norm_layer=norm_layer, activation_layer=nn.ReLU,inplace=False
            )
        )
...
def _efficientnet(
    ...
    if weights is not None:
        ...
        model.load_state_dict(torch.load(model_urls['efficientnet_v2_' + arch]))
    return model
